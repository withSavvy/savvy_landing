#!/usr/bin/env python3
"""Decide a claude-code-action review outcome. Prints ONE token: PASS | ROUTE_HUMAN | FAIL_HARD.
...
Decision tree (first match wins):
  ...
  C. Result event present but is_error -> max-turns routes to human (ran long but
     didn't finish), any other error -> FAIL_HARD.
